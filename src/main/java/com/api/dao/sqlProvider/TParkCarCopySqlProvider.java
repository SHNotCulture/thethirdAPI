...
import com.api.entity.TParkCarCopyCriteria.Criteria;
import com.api.entity.TParkCarCopyCriteria.Criterion;
import org.apache.ibatis.jdbc.SQL;

import java.util.List;
import java.util.Map;

public class TParkCarCopySqlProvider {
     ...
     * @mbg.generated
     */
    public String countByExample(TParkCarCopyCriteria example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("t_park_car_copy");
     ...
     * @mbg.generated
     */
    public String deleteByExample(TParkCarCopyCriteria example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("t_park_car_copy");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbg.generated
     */
    public String insertSelective(TParkCarCopy record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("t_park_car_copy");
     ...
     * @mbg.generated
     */
    public String selectByExample(TParkCarCopyCriteria example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        TParkCarCopy record = (TParkCarCopy) parameter.get("record");
        TParkCarCopyCriteria example = (TParkCarCopyCriteria) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("t_park_car_copy");
     ...
     * @mbg.generated
     */
    public String updateByPrimaryKeySelective(TParkCarCopy record) {
        SQL sql = new SQL();
        sql.UPDATE("t_park_car_copy");
     ...
     * @mbg.generated
     */
    protected void applyWhere(SQL sql, TParkCarCopyCriteria example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
