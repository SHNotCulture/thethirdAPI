...
import com.api.entity.TParkInOutCriteria.Criteria;
import com.api.entity.TParkInOutCriteria.Criterion;
...
public class TParkInOutSqlProvider {
    ...
    String parkId = "_"+ SessionUtil.getParkId();
    ...
    public String insertSelective(TParkInOut record) {
        ...
        if (record.getCloudOrderId() != null) {
            sql.VALUES("cloud_order_id", "#{cloudOrderId,jdbcType=VARCHAR}");
        }
        
        if (record.getSettleDate() != null) {
            sql.VALUES("settle_date", "#{settleDate,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(TParkInOut record) {
        ...
        if (record.getCloudOrderId() != null) {
            sql.SET("cloud_order_id = #{cloudOrderId,jdbcType=VARCHAR}");
        }
        
        if (record.getSettleDate() != null) {
            sql.SET("settle_date = #{settleDate,jdbcType=VARCHAR}");
        }
